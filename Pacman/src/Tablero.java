...
public class Tablero extends JPanel implements ActionListener {
    ...
    private int framesTotalPowerUp = 120;
    private int framesPowerUp = 0;
    ...
    private final short leveldata[] = {
        19+32, 26, 26, 26, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 22+32,
        ...
        1, 25+32, 24, 24, 24, 24, 24, 24, 24, 24, 16, 16, 16, 18, 20,
        9, 8, 8, 8, 8, 8, 8, 8, 8, 8, 25, 24, 24, 24, 28+32
    };
    ...
    private void initVariables() {
        ...
        ghostEat = new boolean[maxghosts];
        dx = new int[4];
        dy = new int[4];
    ...
    private void playGame(Graphics2D g2d) {
        ...
        if(isPowerUp){
            //System.out.println("frames:"+framesPowerUp);
            if(++framesPowerUp>framesTotalPowerUp){
                isPowerUp = false;
